  ...
  const closeAd = () => {
    ...
    <div className="fixed hidden xl:block w-80 overflow-y-auto h-5/6 top-20 right-20">
      <div className="w-3/4 ml-auto">
        <div className="cursor-pointer align-center inline-flex" onClick={closeAd}>
          <XCircle className="w-4 h-4" />
          <h3 className="font-bold text-xs dark:text-white text-black pl-1">广告</h3>
        </div>
        <img className="w-full object-cover h-96" src="/logo.png" alt="赞助广告" />
      </div>
    </div>
	) : null;
}
