...
export const Card: React.FC<PropsWithChildren> = ({ children }) => {
	...
	return (
		<div
			...
			className="overflow-hidden relative dark:duration-700 border dark:border-slate-300 rounded-xl dark:hover:bg-zinc-800/10 hover:bg-zinc-600/10 group md:gap-8 hover:border-zinc-300/50 border-zinc-200"
		>
